...
urlpatterns = [
    ...
    path('web/', TemplateView.as_view(template_name="admin_app/index.html")),
    path('web/manage/', TemplateView.as_view(template_name="admin_app/manage.html")),
    path('web/music/', TemplateView.as_view(template_name="music_app/music.html")),
    ...
    path('api/recommend/<int:pk>/cover/', RecommendUploadCoverView.as_view()),
